...
// 负责人：李启波（marcyli）
//============================================================
- ( NSMutableDictionary *)sendPay_demo:(NSDictionary*)info
{
    ...
    //订单号
    NSString * orderno = [info objectForKey:@"orderId"];
    //ip地址
    NSString * ipStr = [info objectForKey:@"ip"];
    ...
    [packageParams setObject: ipStr    forKey:@"spbill_create_ip"];//发器支付的机器ip
